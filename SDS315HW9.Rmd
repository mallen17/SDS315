...
Max Allen 
mca2773
github -> https://github.com/mallen17/SDS315HW9
...
The plots demonstrate the effect of age on both 1998 voting and receiving the call. The difference in both sides demonstrate age's classification as a confounder in our scenario. The tables show proportion of voters in 1998 on whether or not they received a treatment.As you can see these aren't the same proportions or even close which signifies each having some relationship with 1998 voting. Below it is the same table, but instead of measuring their relationship with 1998 voting it instead shows their proportion on getting the call, causing them to be confounders as well.
